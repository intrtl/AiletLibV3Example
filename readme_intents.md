  ...
  - [1.2 Методы](#12-методы)
    ...
    - [1.2.4 Метод Sync](#124-метод-sync)
      - [Для версии 4.19 Offline и выше](#для-версии-419-offline-и-выше-1)
        - [Параметры](#параметры)
        - [Ошибки](#ошибки)
    - [1.2.5 Метод Show Visit Report](#125-метод-show-visit-report)
...
[ACTION_SHOW_VISIT_REPORT](#125-метод-show-visit-report) | Отчет по визиту 
...
Для версии с поддержкой Palomna в метод `ACTION_REPORT` добавлен новый тип ошибки:
...
### 1.2.5 Метод Show Visit Report

> Версия приложения: 4.20.0 и выше

Открывает отчет по визиту. 
При наличии задач Perfect Store в торговой точке открывается экран торговой точки. Если также передан task_id Perfect Store задачи, открывается экран задачи.
При отсутствии задач Perfect Store в торговой точке открывает экран сводного отчета по визиту.
Доступен просмотр отчета по историческому визиту при наличии подключения к Интернету.
